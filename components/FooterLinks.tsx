  ...
  return (
    <div
      ...
      <div className="flex gap-[24px]">
        <div className="">
          <Image src={'/assets/cross-icon.svg'} alt="cross-icon" width={32} height={29} />
        </div>
        <div className="flex flex-col gap-[24px] md:flex-row">
          <Link href={'/location'}>
            <p className="flex items-center gap-2 font-bold hover:brightness-75">Find A Center</p>
          </Link>
          <Link href={'/contact-us'}>
            <p className="flex items-center gap-2 font-bold hover:brightness-75">Contact Us</p>
          </Link>
